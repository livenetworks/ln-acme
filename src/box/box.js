...
(function () {
	...
	function _init() {
		this.buttons = {};
		this.buttons.collapse = this.dom.querySelectorAll('[ln-box-action="collapse"]');
		this.buttons.expand = this.dom.querySelectorAll('[ln-box-action="expand"]');
	...
	function collapse() {
		this.dom.setAttribute('ln-box', "collapsed");
	}
	function expand() {
		this.dom.setAttribute('ln-box', "");
	}
